...
const CoursePayment = () => {
  ...
  const { courseId, title, price, currency = 'INR' } = useLocalSearchParams();
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        error.response?.data?.message || 'Failed to create payment order. Please try again.'
      );
    }
  };
    ...
    try {
      ...
      Alert.alert(
        ...
        [
          {
            text: 'View Course',
            onPress: () => router.replace(`/course-details?id=${courseId}`),
          },
        ]
      );
    } catch (error) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <View style={styles.card}>
          ...
          <Text style={styles.courseTitle}>{decodeURIComponent(title || 'Course')}</Text>
          ...
          <View style={styles.featuresList}>
            <View style={styles.featureItem}>
              ...
              <Text style={styles.featureText}>Lifetime access to course</Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
              <Text style={styles.featureText}>All course materials included</Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color="#10B981" />
              <Text style={styles.featureText}>Certificate on completion</Text>
            </View>
          </View>
        </View>
